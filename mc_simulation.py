#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Coal / Carbon Intensity Floor
=============================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Coal (Carbon Intensity Floor).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "coal",
    "domain_name": "Coal",
    "theorem": "Carbon Intensity Floor",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 990.0,
    "channels": {
        "C1_co2_climate_damages": {
            ...
            "high": 3420.0,
            "weight": 0.47,
            "description": "CO\u2082 from coal combustion: 15Gt CO\u2082/yr \u00d7 $190/t SCC. 40% of energy-related emissions. Sources: EPA 2023 SCC, IEA, GIVE model."
        },
        "C2_air_pollution_mortality": {
            ...
            "high": 5000.0,
            "weight": 0.62,
            "description": "1M deaths/yr conservative \u00d7 $3.76M global avg VSL. Lelieveld upper: 2.5M deaths. SO\u2082, NOx, PM2.5. Sources: Lelieveld et al. 2023, WHO."
        },
        "C3_coal_mine_methane": {
            ...
            "high": 110.0,
            "weight": 0.012,
            "description": "Coal mine methane at SC-CH\u2084=$1,600/t. Sources: EPA, IEA Global Methane Tracker."
        },
        "C4_extraction_harms": {
            "dist": "lognormal",
            "low": 30.0,
            ...
            "high": 80.0,
            "weight": 0.008,
            "description": "Mountaintop removal, acid mine drainage, subsidence, water contamination. Sources: EPA, OSMRE."
        },
        "C5_mercury_neurotoxicity": {
            ...
            "high": 14.0,
            "weight": 0.001,
            "description": "Mercury emissions \u2014 leading anthropogenic source. Neurodevelopmental damage. Sources: UNEP Minamata, EPA MATS."
        },
        "C6_governance_failure": {
            ...
            "high": 180.0,
            "weight": 0.019,
            "description": "Lobbying delay, $2.4B self-bonded reclamation, stranded-asset socialization. Sources: OpenSecrets, OSMRE, GAO."
        }
    },
